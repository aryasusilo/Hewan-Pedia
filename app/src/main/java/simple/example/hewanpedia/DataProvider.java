...
public class DataProvider {
    ...
    private static List<Merpati> intDataMerpati(Context ctx) {
        List<Merpati> merpatis = new  ArrayList<>();
        merpatis.add(new Merpati("Merpati King", "Amerika Serikat",
                "Umumnya merpati ini ciri-cirinya mempunyai bodi yang bulat/gemuk. Di luar negeri termasuk di Amerika, orang-orang sering menyebut jenis ini dengan merpati “show king”. Tetapi di Indonesia, orang-orang lebih suka menyebutnya hanya dengan panggilan merpati “king” saja.\n" +
                        "\n.",
                R.drawable.merpati_king));
        merpatis.add(new Merpati("Merpati Mondain","Perancis",
                "Awalnya merpati ini juga hanya di gunakan sebagai merpati pedaging karena, bentuk badannya yang gemuk dan bulat besar. Menariknya, merpati ini memiliki kaki yang pendek, sehingga tampak dadanya hampir menyentuh permukaan lantai.",
                R.drawable.merpati_mondain));
        merpatis.add(new Merpati("Merpati Maletese","Austria dan Italia",
                " Ciri khas utama merpati ini adalah bagian leher dan kakinya yang panjang, sedangkan badannya pendek dan sedikit bulat.",
                R.drawable.maltese_min));
        return merpatis;
    }
    ...
    private static void initAllHewans(Context ctx) {
        ...
        hewans.addAll(intDataMerpati(ctx));
    }
